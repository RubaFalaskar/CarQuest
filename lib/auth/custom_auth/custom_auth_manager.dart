...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    carQuestAuthUserSubject.add(
      CarQuestAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<CarQuestAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  CarQuestAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = CarQuestAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    carQuestAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
