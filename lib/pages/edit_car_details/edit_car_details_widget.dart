...
import 'edit_car_details_model.dart';
export 'edit_car_details_model.dart';

class EditCarDetailsWidget extends StatefulWidget {
  const EditCarDetailsWidget({super.key});

  @override
  State<EditCarDetailsWidget> createState() => _EditCarDetailsWidgetState();
}

class _EditCarDetailsWidgetState extends State<EditCarDetailsWidget>
    with TickerProviderStateMixin {
  late EditCarDetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCarDetailsModel());
