...
import 'car_details_f_model.dart';
export 'car_details_f_model.dart';

class CarDetailsFWidget extends StatefulWidget {
  const CarDetailsFWidget({super.key});

  @override
  State<CarDetailsFWidget> createState() => _CarDetailsFWidgetState();
}

class _CarDetailsFWidgetState extends State<CarDetailsFWidget>
    with TickerProviderStateMixin {
  late CarDetailsFModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarDetailsFModel());
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      '- Includes all half-full features plus:\n- Full leather/Alcantara® interiors with custom stitching.\n- Climate-controlled seats.\nBurmester® High-End Surround Sound System.\n-Rear-axle steering and adaptive cruise c ontrol.\n- Exclusive personalization (embossing, carbon-ceramic trim).',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
