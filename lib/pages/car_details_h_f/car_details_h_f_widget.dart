...
import 'car_details_h_f_model.dart';
export 'car_details_h_f_model.dart';

class CarDetailsHFWidget extends StatefulWidget {
  const CarDetailsHFWidget({super.key});

  @override
  State<CarDetailsHFWidget> createState() => _CarDetailsHFWidgetState();
}

class _CarDetailsHFWidgetState extends State<CarDetailsHFWidget>
    with TickerProviderStateMixin {
  late CarDetailsHFModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarDetailsHFModel());
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      '-Includes all standard features plus:\n-Panoramic roof.\n-Ventilated 18-way adaptive sports seats.\n-BOSE® Surround Sound System.\n-Enhanced navigation with local POIs (mosques, petrol stations).\n-Metallic paint options and custom wheels.',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
